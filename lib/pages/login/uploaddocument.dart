                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          ...
                          //     text: bearerToken[0].token.toString()));

                          print(documentsNeeded.length);

                          log('''${bearerToken[0].token.toString()}''');
                          // log('''${bearerToken[0].token.substring(400)}''');
                        },
                        child: Container(
                                                            ...
                                                            decoration:
                                                              ...
                                                              image:
                                                                  DecorationImage(
                                                                      image:
                                                                          NetworkImage(
                                                                        documentsNeeded[i]['driver_document']['data']['document']
                                                                            .toString(),
                                                                      ),
                                                                      fit: BoxFit
                                                                          .cover),
